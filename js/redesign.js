...
(function () {
  ...
  /* 官方內容以《幼童軍訓練綱要》2026 年第十版第三章「活動徽章及其他徽章」為準，
     ...
     ⚠ 以下 4 個係舊制章，2026 第十版目錄已經冇佢哋，所以刻意唔放入 badgeGroups：
       勞作章（舊制頁45）、讀圖章（舊制頁50）、電腦章（舊制頁37）、體操章（舊制頁44）
     保留內容只為過渡期參考（綱言明舊制活動徽章可並列於左袖直至晉升童軍團）。 */
  App.officialBadges={
    ...
    '藝術章':{purpose:'鼓勵幼童軍展現創意及發展多元化的美術技巧。',items:['選擇下列其中三種不同的藝術媒介，分別製作一件藝術作品，展現美術技巧或想像力，並向領袖闡述意念及所運用的技巧：繪畫、雕塑、手工藝、版畫、數碼藝術','如選擇其他藝術媒介，須先取得領袖同意'],page:38},
    '閱讀章':{purpose:'培養幼童軍閱讀風氣及習慣，認識如何使用工具書和知曉怎樣在圖書館尋找書籍。',items:['列出最近閱讀過的書本及作者，向領袖講述其中三本內容；三本須自行選擇，最少包括一本故事書及一本寫實書籍','知曉如何保護及儲存書籍','知曉如何運用中英文字典及地圖集或街道圖','向領袖解釋圖書館書籍如何陳列安放，並找出一本小說'],page:55},
    '娛樂章':{purpose:'讓幼童軍策劃及表演節目，並從中學習與人溝通及合作。',items:['甲組選一項：編排及演出一套戲劇；或在領袖指導下擔任戲劇演出的幕後工作','乙組選一項：組織兒童唱一首歌；領導幼童軍團跳土風舞；或製作簡單樂器並用以伴奏一首歌曲','丙組選一項：演唱兩首民歌；表演三種惹笑動作；講至少五分鐘故事；用樂器奏一首簡單歌曲；或表演三個以上連串雜技或魔術'],note:'如事前取得領袖同意，可做其他水準相同的娛樂性節目。',page:40},
    ...
    '語言章':{purpose:'培養幼童軍非母語表達能力。',items:['除了母語之外，用任何一種語言正確指出鄰近一帶的商店、警署、郵局、教堂、油站及酒店所在地','回答居所、學校或旅部附近公共交通服務情況的簡單問題','解釋「單程路」、「路不通行」、交通燈號及單程票等意思','說出一星期七天和一年十二個月的名稱，並懂得日期的說法'],page:42},
    ...
    '攝影章':{purpose:'讓幼童軍學習攝影基本原則及技巧，培養對攝影的興趣。',items:['拍攝一套12張照片或一段3分鐘長的錄像，記錄一次旅行或活動，內容包括不同主體，並分享作品及講述活動或旅行概況','與領袖討論攝錄器材的基本操作，包括曝光、光圈、快門、感光度（ISO）及焦距，以及如何運用不同拍攝模式獲取效果'],page:46},
    ...
    '烹飪章':{purpose:'培養幼童軍對烹飪的興趣，了解煮食計劃、正確技巧及健康地進行飲食。',items:['與領袖討論兩種不同烹飪方法的優缺點及均衡飲食習慣的重要','預備一份足夠兩人食用的中式或西式膳食，包括計劃餐單、烹調、餐桌安排、上菜及清理餐桌，並先獲主考同意','預備熱飲品及小食，作為下午茶或輕便午餐','向領袖解釋廚房及煮食的安全措施及衞生守則'],note:'菜式不可純以市面購買的預製食品完成，但可使用預製食品作為其中烹調食材。',page:58},
    ...
    '音樂章':{purpose:'培養幼童軍對音樂的興趣，並能展示基本技能。',items:['清楚辨認五線譜上的音名，並解釋六種基本音樂術語，包括高音譜號、低音譜號、休止符及音符等','唱出或演奏兩首自選的不同風格歌曲','完成以下任何兩項：視奏或視唱指定樂曲；辨識樂器結構；保養樂器或聲線；以拍掌完成三段指定節奏；指出兩段樂曲所用樂器；認識歌劇、芭蕾舞或民謠歌曲的故事背景；創作六至八小節音樂；為一段音樂譜上新歌詞'],page:44},
    ...
    '運動章':{purpose:'鼓勵幼童軍主動認識運動技能及安全守則，培養平日做運動的興趣及習慣。',items:['對兩種運動有廣泛認識','對其中一項具專門技能及知識，並經常參加該項活動','知曉如何保養所選運動所需的用具及服裝','在所有幼童軍遊戲及活動中表現良好體育精神','明瞭每次運動後沐浴或更衣的重要性，以及保護足部的重要性'],page:65},
    '田徑章':{purpose:'鼓勵幼童軍參與田徑活動，了解相關安全知識，並能展示基本技能。',items:['必須完成官方列出的全部四個田徑項目','初級（紅色）及格分數：22分','中級（黃色）及格分數：28分','高級（綠色）及格分數：34分'],note:'目前已核實官方目的、四項必修制度、三級顏色及評分門檻；四個具體田徑項目仍待從官方第32頁完整提取，故本章暫不計入完成百分比。',page:54},
    ...
    '寫作章':{purpose:'培養幼童軍寫作興趣。',items:['創作一個故事或一首詩','寫一封不少於200字的信給親友，描述成為幼童軍後參與過最有意義或最有趣的事，並正確在信封寫上收信人、發信人及地址','發出一封電郵給親友，邀請他們參加團部活動，或向他們表達對特別事件的謝意'],page:47},
