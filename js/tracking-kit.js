...
var TrackingKit = {
 ...
 scope:'香港官方追蹤工作紙已核對名稱；本套六圖依馬耳他童軍協會教材的明確文字自行繪製，並非香港官方原圖。香港完整圖表仍待逐圖比對，正式考驗由領袖按適用教材確認。',
 items:[
 ...
 note:function(){return '<p class="reference-credit">'+esc(TrackingKit.scope)+'</p>';},
 ...
 sheets:function(mode){if(!['cards','guide','worksheet'].includes(mode))return '';if(mode==='guide')return '<section class="psheet leader-sheet tracking-guide"><h2>追蹤符號｜領袖答案與三站帶法</h2><div class="tracking-key-grid">'+TrackingKit.items.map(function(s,i){return '<article>'+TrackingKit.svg(i)+'<b>'+String.fromCharCode(65+i)+' · '+esc(s.name)+'</b><p>'+esc(s.answer)+'</p></article>';}).join('')+'</div><p><b>物資：</b>每組一套六張剪卡；成人裁卡剪刀1把，信物紙訊息1張（可選），每人紙筆。剪刀由成人在活動前使用及收好。</p>'+TrackingKit.plan()+TrackingKit.note()+'<p class="reference-credit">來源：香港幼童軍天地 TrackingSigns.pdf（2019）；Scouts Malta B01 Tracking Signs，B01.1–B01.3。每組一套剪卡；可另印多套。未完成香港完整圖表核對。</p></section>';
...
(function(){
 ...
 m.gap='已附六款追蹤圖卡、配對及三站帶法；圖依外部童軍教材文字繪製，香港官方完整圖表仍待逐圖比對，正式考驗由領袖確認。室內練習不代替郊野守則的郊野公園活動要求。';
 ...
 DATA.materials.push({n:'成人裁卡剪刀',base:1,per:0,unit:'把',note:'成人在活動前剪開圖卡並收好；不在追蹤路線中拿著剪刀。'},{n:'六步練習紙訊息（可選）',base:1,per:0,unit:'張',note:'做六步信物才需要；成人预先放在可見安全範圍，不放食物、獎金或私人資料。'});
