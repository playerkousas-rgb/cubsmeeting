...
/* 1. 靜態PWA：無build step */
{
  ...
  ["index.html", "css/app.css", "js/data.js", "js/guide.js", "js/flow.js", "js/app.js", "manifest.webmanifest", "sw.js"].forEach((f) =>
    ok(fs.existsSync(path.join(root, f)), `有 ${f}`));
}
/* 2. SW cache齊 */
{
  const sw = read("sw.js");
  ["index.html", "css/app.css", "js/data.js", "js/guide.js", "js/flow.js", "js/app.js", "manifest.webmanifest"].forEach((a) =>
